...
QB.Phone.Functions.SetupApplications = function(data) {
    ...
    $.each(data.applications, function(i, app){
        ...
        if ((!app.job || app.job === QB.Phone.Data.PlayerJob.name) && !blockedapp) {
            ...
            if (app.app == "meos") {
                icon = '<img src="./img/apps/police.png" style="width: 100%;">';
                ...
                icon = '<img src="./img/apps/twitter.png" style="width: 100%;">';
                ...
                icon = '<img src="./img/apps/garages.png" style="width: 100%;">';
            } else if (app.app == "whatsapp"){
                icon = '<img src="./img/apps/whatsapp.png" style="width: 100%;">';
            } else if (app.app == "mail"){
                icon = '<img src="./img/apps/mail.png" style="width: 100%;">';
            } else if (app.app == "advert"){
                icon = '<img src="./img/apps/yellow_pages.png" style="width: 100%;">';
            } else if (app.app == "bank"){
                icon = '<img src="./img/apps/bank.png" style="width: 100%;">';
                ...
                icon = '<img src="./img/apps/home.png" style="width: 100%;">';
            } else if (app.app == "lawyers"){
                icon = '<img src="./img/apps/business.png" style="width: 100%;">';
            } else if (app.app == "calculator"){
                icon = '<img src="./img/apps/calculator.png" style="width: 100%;">';
            }
