...
$(document).on('click', '#accept-background', function(e){
    ...
    if (hasCustomBackground === false) {
        ...
        $(".iphone-14").css({"background-image":"url('/html/img/backgrounds/"+QB.Phone.Settings.Background+".png')"});
        ...
        $(".iphone-14").css({"background-image":"url('"+QB.Phone.Settings.Background+"')"});
